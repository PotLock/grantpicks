...
export declare const networks: {
	readonly testnet: {
		...
		readonly contractId: 'CAJUJPM6KRM4I7JVXPNPLYWZMEXIZNALD6PKVR2JBX6JK7JGCJSQCTDG'
	}
}
...
export declare class Client extends ContractClient {
	...
	readonly fromJSON: {
		...
		register_batch: (
			json: string,
		) => AssembledTransaction<RegistrationExternal[]>
		...
		get_lists_for_registrant: (
			json: string,
		) => AssembledTransaction<ListExternal[]>
