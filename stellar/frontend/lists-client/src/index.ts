...
export const networks = {
	testnet: {
		...
		contractId: 'CCMTZXCHTZNMUY2JEY5CMG2YKMQN5KCBON2C3CKYAYHFRRSTEODYCH5F',
	},
} as const
...
export type ContractKey =
	...
	| { tag: 'Lists'; values: void }
	| { tag: 'ListAdmins'; values: void }
	| { tag: 'OwnedList'; values: void }
	| { tag: 'RegistrantList'; values: void }
	| { tag: 'RegistrationsNumber'; values: void }
	| { tag: 'Registrations'; values: void }
	| { tag: 'ListRegistration'; values: void }
	| { tag: 'RegistrationsIDs'; values: void }
	| { tag: 'Upvotes'; values: void }
	| { tag: 'UserUpvotes'; values: void }
...
export interface Client {
	 ...
	 */
	delete_list: (
		{ owner, list_id }: { owner: string; list_id: u128 },
		options?: {
			/**
			 * The fee to pay for the transaction. Default: BASE_FEE
			 */
	...
	transfer_ownership: (
		{
			...
			list_id,
			new_owner_id,
		}: { owner: string; list_id: u128; new_owner_id: string },
		options?: {
			/**
			 * The fee to pay for the transaction. Default: BASE_FEE
			 */
	...
	add_admins: (
		{
			...
			list_id,
			admins,
		}: { owner: string; list_id: u128; admins: Array<string> },
		options?: {
			/**
			 * The fee to pay for the transaction. Default: BASE_FEE
			 */
