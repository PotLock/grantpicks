...
export const networks = {
  ...
  public: {
    ...
    contractId: "CAIYXP5CNFB5WUBAWEPBZHIKYZGP3IEFXILFMDUT37FZBKNGFJGNJPNT",
  }
} as const
...
export type ContractKey =
	| { tag: 'ContractOwner'; values: void }
	| { tag: 'ListsNumber'; values: void }
	| { tag: 'Lists'; values: readonly [u128] }
	| { tag: 'ListAdmins'; values: readonly [u128] }
	| { tag: 'OwnedList'; values: readonly [string] }
	| { tag: 'RegistrantList'; values: readonly [string] }
	| { tag: 'RegistrationsNumber'; values: void }
	| { tag: 'Registrations'; values: readonly [u128] }
	| { tag: 'ListRegistration'; values: readonly [u128] }
	| { tag: 'RegistrationsIDs'; values: readonly [string] }
	| { tag: 'Upvotes'; values: readonly [u128] }
	| { tag: 'UserUpvotes'; values: readonly [string] }
...
export interface Client {
	 ...
	 */
	upvote: (
		{ voter, list_id }: { voter: string; list_id: u128 },
		options?: {
			/**
			 * The fee to pay for the transaction. Default: BASE_FEE
			 */
	 ...
	 */
	transfer_ownership: (
		{ list_id, new_owner_id }: { list_id: u128; new_owner_id: string },
		options?: {
			/**
			 * The fee to pay for the transaction. Default: BASE_FEE
			 */
	 ...
	 */
	add_admins: (
		{ list_id, admins }: { list_id: u128; admins: Array<string> },
		options?: {
			/**
			 * The fee to pay for the transaction. Default: BASE_FEE
			 */
	...
	get_lists_for_registrant: (
		{ registrant_id }: { registrant_id: string },
		options?: {
			/**
			 * The fee to pay for the transaction. Default: BASE_FEE
			 */
	 ...
	 */
	get_upvotes_for_list: (
		{
			list_id,
			from_index,
			limit,
		}: { list_id: u128; from_index: Option<u64>; limit: Option<u64> },
		options?: {
			/**
			 * The fee to pay for the transaction. Default: BASE_FEE
			 */
	...
	get_upvoted_lists_for_account: (
		{
			...
			from_index,
			limit,
		}: { user: string; from_index: Option<u64>; limit: Option<u64> },
		options?: {
			/**
			 * The fee to pay for the transaction. Default: BASE_FEE
			 */
	 ...
	 */
	get_registration: (
		{ registration_id }: { registration_id: u128 },
		options?: {
			/**
			 * The fee to pay for the transaction. Default: BASE_FEE
			 */
