...
export type ContractKey =
	| { tag: 'NumOfProjects'; values: void }
	| { tag: 'Projects'; values: void }
	| { tag: 'Project'; values: readonly [u128] }
	| { tag: 'RegistryAdmin'; values: void }
	| { tag: 'ApplicantToProjectID'; values: readonly [string] }
...
export interface Client {
	 ...
	 */
	initialize: (
		{ contract_owner }: { contract_owner: string },
		options?: {
			/**
	...
	apply: (
		{
			applicant,
			project_params,
		}: { applicant: string; project_params: CreateProjectParams },
		options?: {
			/**
			 * The fee to pay for the transaction. Default: BASE_FEE
			 */
	 ...
	 */
	add_admin: (
		{ project_id, new_admin }: { project_id: u128; new_admin: string },
		options?: {
			/**
			 * The fee to pay for the transaction. Default: BASE_FEE
			 */
	...
	remove_admin: (
		{
			project_id,
			admin_to_remove,
		}: { project_id: u128; admin_to_remove: string },
		options?: {
			/**
			 * The fee to pay for the transaction. Default: BASE_FEE
			 */
	 ...
	 */
	get_projects: (
		{ skip, limit }: { skip: Option<u64>; limit: Option<u64> },
		options?: {
			/**
			 * The fee to pay for the transaction. Default: BASE_FEE
			 */
