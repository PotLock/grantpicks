...
export const networks = {
	testnet: {
		...
		contractId: 'CCAVVRHJ77XX5ZTAQEMAGIONVI42GGOTOMSQPWCMRTHPIW7N5NDKEUT2',
	},
} as const
...
export type ContractKey =
	...
	| { tag: 'ApplicantToProjectID'; values: void }
...
export interface Client {
	...
	apply: (
		{
			applicant,
			project_params,
		}: { applicant: string; project_params: ProjectParams },
		options?: {
			/**
			 * The fee to pay for the transaction. Default: BASE_FEE
			 */
	...
	change_project_status: (
		{
			...
			project_id,
			new_status,
		}: { contract_owner: string; project_id: u128; new_status: ProjectStatus },
		options?: {
			/**
			 * The fee to pay for the transaction. Default: BASE_FEE
			 */
	...
	add_admin: (
		{
			...
			project_id,
			new_admin,
		}: { admin: string; project_id: u128; new_admin: string },
		options?: {
			/**
			 * The fee to pay for the transaction. Default: BASE_FEE
			 */
	...
	remove_admin: (
		{
			...
			project_id,
			admin_to_remove,
		}: { admin: string; project_id: u128; admin_to_remove: string },
		options?: {
			/**
			 * The fee to pay for the transaction. Default: BASE_FEE
			 */
	 ...
	 */
	upgrade: (
		{ owner, new_wasm_hash }: { owner: string; new_wasm_hash: Buffer },
		options?: {
			/**
			 * The fee to pay for the transaction. Default: BASE_FEE
			 */
...
export class Client extends ContractClient {
	constructor(public readonly options: ContractClientOptions) {
		super(
			new ContractSpec([
				...
				'AAAAAAAAAAAAAAAaZ2V0X3Byb2plY3RfZnJvbV9hcHBsaWNhbnQAAAAAAAEAAAAAAAAACWFwcGxpY2FudAAAAAAAABMAAAABAAAD6AAAB9AAAAAHUHJvamVjdAA=',
	...
	public readonly fromJSON = {
		...
		get_project_from_applicant: this.txFromJSON<Option<Project>>,
	}
}
