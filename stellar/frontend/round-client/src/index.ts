...
export type ContractKey =
	...
	| { tag: 'WhitelistAndBlacklist'; values: readonly [u128] }
	...
	flag_voter: (
		{
			...
			admin,
			voter,
		}: { round_id: u128; admin: string; voter: string },
		options?: {
			/**
			 * The fee to pay for the transaction. Default: BASE_FEE
			 */
	...
	add_white_list: (
		{
			...
			admin,
			address,
		}: { round_id: u128; admin: string; address: string },
		options?: {
			/**
			 * The fee to pay for the transaction. Default: BASE_FEE
			 */
