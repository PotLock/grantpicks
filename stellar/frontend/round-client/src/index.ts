...
export const networks = {
  ...
  public: {
    ...
    contractId: "CDCRTJQ3SP2LJEOT5EA2B6WTGUUI6BVYDJXKYRJCKRSPSYJHXV5V6X3O",
  }
} as const
...
export type ContractKey =
	...
	| { tag: 'ProjectPayoutIds'; values: readonly [u128] }
	...
	| { tag: 'VotedRoundIds'; values: readonly [string] }
...
export interface Client {
	...
	create_round: (
		{
			caller,
			round_detail,
		}: { caller: string; round_detail: CreateRoundParams },
		options?: {
			/**
			 * The fee to pay for the transaction. Default: BASE_FEE
			 */
	 ...
	 */
	change_kyc_wl_list_id: (
		{ list_id }: { list_id: u128 },
		options?: {
			/**
			 * The fee to pay for the transaction. Default: BASE_FEE
			 */
	...
	set_expected_amount: (
		{
			...
			caller,
			amount,
		}: { round_id: u128; caller: string; amount: u128 },
		options?: {
			/**
			 * The fee to pay for the transaction. Default: BASE_FEE
			 */
	...
	vote: (
		{
			...
			voter,
			picks,
		}: { round_id: u128; voter: string; picks: Array<PickedPair> },
		options?: {
			/**
			 * The fee to pay for the transaction. Default: BASE_FEE
			 */
	...
	flag_voters: (
		{
			...
			admin,
			voters,
		}: { round_id: u128; admin: string; voters: Array<string> },
		options?: {
			/**
			 * The fee to pay for the transaction. Default: BASE_FEE
			 */
	...
	get_votes_for_round: (
		{
			...
			skip,
			limit,
		}: { round_id: u128; skip: Option<u64>; limit: Option<u64> },
		options?: {
			/**
			 * The fee to pay for the transaction. Default: BASE_FEE
			 */
	...
	add_approved_project: (
		{
			...
			admin,
			project_ids,
		}: { round_id: u128; admin: string; project_ids: Array<u128> },
		options?: {
			/**
			 * The fee to pay for the transaction. Default: BASE_FEE
			 */
	...
	unapply_from_round: (
		{
			...
			caller,
			applicant,
		}: { round_id: u128; caller: string; applicant: Option<string> },
		options?: {
			/**
			 * The fee to pay for the transaction. Default: BASE_FEE
			 */
	...
	update_applicant_note: (
		{
			...
			caller,
			note,
		}: { round_id: u128; caller: string; note: string },
		options?: {
			/**
			 * The fee to pay for the transaction. Default: BASE_FEE
			 */
	...
	challenge_payouts: (
		{
			...
			caller,
			reason,
		}: { round_id: u128; caller: string; reason: string },
		options?: {
			/**
			 * The fee to pay for the transaction. Default: BASE_FEE
			 */
	...
	redistribute_vault: (
		{
			...
			caller,
			memo,
		}: { round_id: u128; caller: string; memo: Option<string> },
		options?: {
			/**
			 * The fee to pay for the transaction. Default: BASE_FEE
			 */
	...
	get_voted_rounds: (
		{
			...
			from_index,
			limit,
		}: { voter: string; from_index: Option<u64>; limit: Option<u64> },
		options?: {
			/**
			 * The fee to pay for the transaction. Default: BASE_FEE
			 */
	...
	unflag_project: (
		{
			...
			caller,
			project_id,
		}: { round_id: u128; caller: string; project_id: u128 },
		options?: {
			/**
			 * The fee to pay for the transaction. Default: BASE_FEE
			 */
