...
export const networks = {
	testnet: {
		...
		contractId: 'CCVVNTUD6CFPKZ2C4JAZIQGCAK2S6D6KPP5IELGHTHHJPYV2B62GPJTK',
	},
} as const
...
export type RegistrationStatus =
	...
	| { tag: 'Approved'; values: void }
	| { tag: 'Rejected'; values: void }
	| { tag: 'Graylisted'; values: void }
	| { tag: 'Blacklisted'; values: void }

export type ContractKey =
	| { tag: 'Config'; values: void }
	| { tag: 'NextRoundId'; values: void }
	| { tag: 'NextPayoutId'; values: void }
	| { tag: 'NextDepositId'; values: void }
	| { tag: 'ProjectPayoutIds'; values: void }
	| { tag: 'VotedRoundIds'; values: void }
	| { tag: 'PayoutInfo'; values: readonly [u128] }
	| { tag: 'DepositInfo'; values: readonly [u128] }
	| { tag: 'RoundInfo'; values: readonly [u128] }
	| { tag: 'BlackList'; values: readonly [u128] }
	| { tag: 'ProjectApplicants'; values: readonly [u128] }
	| { tag: 'ApprovedProjects'; values: readonly [u128] }
	| { tag: 'FlaggedProjects'; values: readonly [u128] }
	| { tag: 'Payouts'; values: readonly [u128] }
	| { tag: 'PayoutChallenges'; values: readonly [u128] }
	| { tag: 'VotingState'; values: readonly [u128] }
	| { tag: 'Votes'; values: readonly [u128] }
	| { tag: 'ProjectVotingCount'; values: readonly [u128] }
	| { tag: 'Admin'; values: readonly [u128] }
	| { tag: 'Deposit'; values: readonly [u128] }
...
export interface Client {
	 ...
	 */
	create_round: (
		{ caller, round_detail }: { caller: string; round_detail: CreateRoundParams },
		options?: {
			/**
			 * The fee to pay for the transaction. Default: BASE_FEE
			 */
	 ...
	 */
	get_rounds: (
		{ from_index, limit }: { from_index: Option<u64>; limit: Option<u64> },
		options?: {
			/**
			 * The fee to pay for the transaction. Default: BASE_FEE
			 */
	 ...
	 */
	owner_set_default_page_size: (
		{ default_page_size }: { default_page_size: u64 },
		options?: {
			/**
			 * The fee to pay for the transaction. Default: BASE_FEE
			 */
	 ...
	 */
	owner_set_protocol_fee_config: (
		{
			protocol_fee_recipient,
			protocol_fee_basis_points,
		}: { protocol_fee_recipient: Option<string>; protocol_fee_basis_points: Option<u32> },
		options?: {
			/**
			 * The fee to pay for the transaction. Default: BASE_FEE
			 */
	...
	set_voting_period: (
		{
			...
			start_ms,
			end_ms,
		}: { round_id: u128; caller: string; start_ms: u64; end_ms: u64 },
		options?: {
			/**
			 * The fee to pay for the transaction. Default: BASE_FEE
			 */
	 ...
	 */
	set_expected_amount: (
		{ round_id, caller, amount }: { round_id: u128; caller: string; amount: u128 },
		options?: {
			/**
			 * The fee to pay for the transaction. Default: BASE_FEE
			 */
	 ...
	 */
	set_admins: (
		{ round_id, round_admin }: { round_id: u128; round_admin: Array<string> },
		options?: {
			/**
			 * The fee to pay for the transaction. Default: BASE_FEE
			 */
	 ...
	 */
	vote: (
		{ round_id, voter, picks }: { round_id: u128; voter: string; picks: Array<PickedPair> },
		options?: {
			/**
			 * The fee to pay for the transaction. Default: BASE_FEE
			 */
	 ...
	 */
	flag_voters: (
		{ round_id, admin, voters }: { round_id: u128; admin: string; voters: Array<string> },
		options?: {
			/**
			 * The fee to pay for the transaction. Default: BASE_FEE
			 */
	 ...
	 */
	process_payouts: (
		{ round_id, caller }: { round_id: u128; caller: string },
		options?: {
			/**
			 * The fee to pay for the transaction. Default: BASE_FEE
			 */
	 ...
	 */
	get_votes_for_round: (
		{ round_id, skip, limit }: { round_id: u128; skip: Option<u64>; limit: Option<u64> },
		options?: {
			/**
			 * The fee to pay for the transaction. Default: BASE_FEE
			 */
	 ...
	 */
	can_vote: (
		{ round_id, voter }: { round_id: u128; voter: string },
		options?: {
			/**
			 * The fee to pay for the transaction. Default: BASE_FEE
			 */
	...
	get_applications_for_round: (
		{
			...
			from_index,
			limit,
		}: { round_id: u128; from_index: Option<u64>; limit: Option<u64> },
		options?: {
			/**
			 * The fee to pay for the transaction. Default: BASE_FEE
			 */
	 ...
	 */
	get_application: (
		{ round_id, applicant }: { round_id: u128; applicant: string },
		options?: {
			/**
			 * The fee to pay for the transaction. Default: BASE_FEE
			 */
	...
	add_approved_project: (
		{ round_id, admin, project_ids }: { round_id: u128; admin: string; project_ids: Array<u128> },
		options?: {
			/**
			 * The fee to pay for the transaction. Default: BASE_FEE
			 */
	 ...
	 */
	whitelist_status: (
		{ round_id, address }: { round_id: u128; address: string },
		options?: {
			/**
			 * The fee to pay for the transaction. Default: BASE_FEE
			 */
	 ...
	 */
	get_pair_by_index: (
		{ round_id, index }: { round_id: u128; index: u32 },
		options?: {
			/**
			 * The fee to pay for the transaction. Default: BASE_FEE
			 */
	...
	set_number_of_votes: (
		{
			...
			admin,
			num_picks_per_voter,
		}: { round_id: u128; admin: string; num_picks_per_voter: u32 },
		options?: {
			/**
			 * The fee to pay for the transaction. Default: BASE_FEE
			 */
	...
	transfer_round_ownership: (
		{ round_id, new_owner }: { round_id: u128; new_owner: string },
		options?: {
			/**
			 * The fee to pay for the transaction. Default: BASE_FEE
			 */
	 ...
	 */
	unapply_from_round: (
		{ round_id, caller, applicant }: { round_id: u128; caller: string; applicant: Option<string> },
		options?: {
			/**
			 * The fee to pay for the transaction. Default: BASE_FEE
			 */
	 ...
	 */
	update_applicant_note: (
		{ round_id, caller, note }: { round_id: u128; caller: string; note: string },
		options?: {
			/**
			 * The fee to pay for the transaction. Default: BASE_FEE
			 */
	...
	update_round: (
		{
			...
			round_id,
			round_detail,
		}: { caller: string; round_id: u128; round_detail: UpdateRoundParams },
		options?: {
			/**
			 * The fee to pay for the transaction. Default: BASE_FEE
			 */
	...
	set_payouts: (
		{
			...
			payouts,
			clear_existing,
		}: { round_id: u128; caller: string; payouts: Array<PayoutInput>; clear_existing: boolean },
		options?: {
			/**
			 * The fee to pay for the transaction. Default: BASE_FEE
			 */
	 ...
	 */
	challenge_payouts: (
		{ round_id, caller, reason }: { round_id: u128; caller: string; reason: string },
		options?: {
			/**
			 * The fee to pay for the transaction. Default: BASE_FEE
			 */
	 ...
	 */
	redistribute_vault: (
		{ round_id, caller, memo }: { round_id: u128; caller: string; memo: Option<string> },
		options?: {
			/**
			 * The fee to pay for the transaction. Default: BASE_FEE
			 */
	...
	set_cooldown_config: (
		{
			...
			caller,
			cooldown_period_ms,
		}: { round_id: u128; caller: string; cooldown_period_ms: Option<u64> },
		options?: {
			/**
			 * The fee to pay for the transaction. Default: BASE_FEE
			 */
	 ...
	 */
	get_voted_rounds: (
		{ voter, from_index, limit }: { voter: string; from_index: Option<u64>; limit: Option<u64> },
		options?: {
			/**
			 * The fee to pay for the transaction. Default: BASE_FEE
			 */
	...
	flag_project: (
		{
			...
			project_id,
			reason,
		}: { round_id: u128; caller: string; project_id: u128; reason: string },
		options?: {
			/**
			 * The fee to pay for the transaction. Default: BASE_FEE
			 */
	 ...
	 */
	unflag_project: (
		{ round_id, caller, project_id }: { round_id: u128; caller: string; project_id: u128 },
		options?: {
			/**
			 * The fee to pay for the transaction. Default: BASE_FEE
			 */
...
export class Client extends ContractClient {
	constructor(public readonly options: ContractClientOptions) {
		super(
			new ContractSpec([
				...
				'',
				'',
				'',
				'',
				...
				'',
				'',
				...
				'',
				...
				'AAAAAAAAAAAAAAASY2hhbmdlX2t5Y19saXN0X2lkAAAAAAABAAAAAAAAAAtreWNfbGlzdF9pZAAAAAAKAAAAAA==',
				...
				'',
			]),
			options
		)
	}
	public readonly fromJSON = {
		...
		change_kyc_list_id: this.txFromJSON<null>,
