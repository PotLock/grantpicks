								...
								<InputText
									...
									errorMessage={
										parseFloat(watch().amount) < 0 ? (
											<p className="text-red-500 text-xs mt-1 ml-2">
												Initial deposit can not be less than 0
											</p>
										) : undefined
									}
								/>
									...
									errorMessage={
										errors.expected_amount?.type === 'required' ? (
										  ...
										  parseFloat(watch().amount) ? (
											...
											<p className="text-red-500 text-xs mt-1 ml-2">
												Expected Amount can not be less than 0
											</p>
										) : undefined
									}
								/>
							...
							<InputText
								...
								errorMessage={
									errors.cooldown_end_ms?.type === 'required' ? (
										...
										<p className="text-red-500 text-xs mt-1 ml-2">
											Cooldown deadline can not be less than 0
										</p>
									) : undefined
								}
							/>
							...
							<InputText
								...
								errorMessage={
									errors.compliance_period_ms?.type === 'required' ? (
									  ...
									  0 ? (
										<p className="text-red-500 text-xs mt-1 ml-2">
											Compliance deadline can not be less than 0
										</p>
									) : undefined
								}
							/>
