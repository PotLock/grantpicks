...
export const ListForm = ({ listId, existingList }: ListFormProps) => {
	...
	useEffect(() => {
		if (existingList && listId) {
			...
			setValue(
				...
				existingList.default_registration_status === 'Approved',
			)
	...
	return (
		<div className="flex flex-col text-grantpicks-black-950 gap-y-4 w-full justify-center items-center">
			<h1 className="text-4xl font-extrabold text-grantpicks-black-950">
			...
			<div className="flex flex-col gap-y-4 md:p-12 box-shadow-2xl border border-[#b0b0b0] rounded-2xl p-4 w-full md:w-[60%] items-start justify-center">
				<h2 className="text-lg font-semibold text-center text-grantpicks-black-950">
					List Details
				</h2>
				...
				<div className="flex flex-col items-start gap-y-2 justify-between w-full pb-4 border border-black/10 rounded-xl p-4">
					...
					<div className="flex items-center gap-x-1">
						...
						<p className="text-grantpicks-black-950">
							New Applications will be approved automatically.
						</p>
					</div>
				</div>
				...
				<div className="flex flex-col gap-y-4 w-full">
					<p className="text-lg font-semibold text-grantpicks-black-950">
						Upload Cover Image
					</p>
						...
						{isPending ? (
							<div className="w-full aspect-video relative flex items-center justify-center">
								<div className="flex flex-col items-center">
									<IconLoading
										size={24}
										className="fill-grantpicks-black-900"
									/>
