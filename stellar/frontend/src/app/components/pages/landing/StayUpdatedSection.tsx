...
const StayUpdatedSection = () => {
	...
	return (
		<div className="pt-20 md:pt-24 xl:pt-32 flex flex-col w-full mx-auto">
			<div className="relative z-10 flex justify-center rounded-[40px] py-9 sm:py-[67px] px-9 sm:px-[61px] bg-[#743CF6] shadow-[0px_8px_20px_0px_rgba(0,0,0,0.05),0px_4px_12px_0px_rgba(0,0,0,0.1),0px_2px_4px_0px_rgba(0,0,0,0.1),inset_0px_0.5px_0px_0px_rgba(0,0,0,0.1)]">
