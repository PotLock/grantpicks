  ...
  <div className="max-w-7xl mx-auto px-4 md:px-6">
    <div className="sticky top-0 z-10 -mx-4 md:-mx-6 px-4 md:px-6 pt-4 pb-3 bg-white border-b border-black/10">
      <div className="flex items-center overflow-x-auto space-x-2 md:space-x-3" role="tablist" aria-label="Application filters">
        <div className="rounded-full px-4 py-2 flex-shrink-0 text-sm font-semibold bg-grantpicks-black-50 text-transparent">All</div>
        <div className="rounded-full px-4 py-2 flex-shrink-0 text-sm font-semibold bg-grantpicks-black-50 text-transparent">Pending</div>
        <div className="rounded-full px-4 py-2 flex-shrink-0 text-sm font-semibold bg-grantpicks-black-50 text-transparent">Accepted</div>
        <div className="rounded-full px-4 py-2 flex-shrink-0 text-sm font-semibold bg-grantpicks-black-50 text-transparent">Rejected</div>
      </div>
    </div>
    <div className="py-4 grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-4 md:gap-6">
      {Array.from({ length: 6 }).map((_, i) => (
        <div key={i} className="border border-black/10 rounded-xl p-4 bg-white animate-pulse">
