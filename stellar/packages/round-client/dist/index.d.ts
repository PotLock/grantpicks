...
export declare const networks: {
    readonly testnet: {
        ...
        readonly contractId: "CCQRMOW4YFIY6MHUMHODGPBNSGVUGPRAHRWT6MBGEZHVYDJUHQ26ATHX";
    };
};
...
export interface Client {
     ...
     */
    initialize: ({ owner, token_address, registry_address, round_detail }: {
        owner: string;
     ...
     */
    change_voting_period: ({ admin, round_start_ms, round_end_ms }: {
        admin: string;
        round_start_ms: u64;
        round_end_ms: u64;
    }, options?: {
     ...
     */
    change_application_period: ({ admin, round_application_start_ms, round_application_end_ms }: {
        admin: string;
     ...
     */
    remove_admin: ({ admin, round_admin }: {
        admin: string;
        round_admin: string;
    }, options?: {
        /**
     ...
     */
    apply_project: ({ project_id, applicant }: {
        project_id: u128;
        applicant: string;
    }, options?: {
        /**
     ...
     */
    review_application: ({ admin, application_id, status, note }: {
        admin: string;
        application_id: u128;
        status: ApplicationStatus;
        note: Option<string>;
     ...
     */
    get_all_applications: ({ skip, limit }: {
        skip: Option<u64>;
        limit: Option<u64>;
    }, options?: {
        /**
     ...
     */
    add_approved_project: ({ admin, project_ids }: {
        admin: string;
     ...
     */
    remove_approved_project: ({ admin, project_ids }: {
        admin: string;
        project_ids: Array<u128>;
    }, options?: {
        /**
     ...
     */
    remove_from_white_list: ({ admin, address }: {
        admin: string;
        address: string;
    }, options?: {
        /**
     ...
     */
    change_number_of_votes: ({ admin, num_picks_per_voter }: {
        admin: string;
        num_picks_per_voter: u32;
    }, options?: {
        /**
