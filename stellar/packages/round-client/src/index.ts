...
export const networks = {
  testnet: {
    ...
    contractId: "CDSVOIKVQPUXBMFLDKUSPI55DM6F7BODCDPFANAKDPHRBUSZE3PWNVFH",
  }
} as const
...
export class Client extends ContractClient {
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "AAAAAgAAAAAAAAAAAAAAEUFwcGxpY2F0aW9uU3RhdHVzAAAAAAAAAwAAAAAAAAAAAAAAB1BlbmRpbmcAAAAAAAAAAAAAAAAIQXBwcm92ZWQAAAAAAAAAAAAAAAhSZWplY3RlZA==",
        ...
        "AAAAAAAAAAAAAAAKcm91bmRfaW5mbwAAAAAAAQAAAAAAAAAIcm91bmRfaWQAAAAKAAAAAQAAB9AAAAATUm91bmREZXRhaWxFeHRlcm5hbAA=",
  ...
  public readonly fromJSON = {
    initialize: this.txFromJSON<null>,
        ...
        round_info: this.txFromJSON<RoundDetailExternal>,
