...
export declare const networks: {
    readonly testnet: {
        ...
        readonly contractId: "CASX62ZPKBNWW5JPOEJDXEZ435LLQK2GPWFHONOXNSKDXZJJQKE5F6NP";
    };
};
...
export interface Client {
     ...
     */
    init: ({ owner, token_address, registry_address, round_detail }: {
        owner: string;
     ...
     */
    change_voting_period: ({ admin, round_start_time, round_end_time }: {
        admin: string;
     ...
     */
    change_application_period: ({ admin, round_application_start_time, round_application_end_time }: {
        admin: string;
